...
export function About() {
  ...
  const stats = [
    { icon: Calendar, value: "10+", label: t(translations.about.yearsOfExperience, lang) },
    { icon: Globe, value: "3", label: t(translations.about.continentsServed, lang) },
    { icon: FolderKanban, value: "500+", label: t(translations.about.successfulProjects, lang) },
  ];
