...
import { Shirt, Footprints, Monitor, GraduationCap, Package } from "lucide-react";
...
export function Services() {
  ...
  const services = [
    { icon: Shirt, number: "01", title: t(translations.services.textileTitle, lang), description: t(translations.services.textileDesc, lang) },
    { icon: Footprints, number: "02", title: t(translations.services.footwearTitle, lang), description: t(translations.services.footwearDesc, lang) },
    { icon: Monitor, number: "03", title: t(translations.services.itTitle, lang), description: t(translations.services.itDesc, lang), featured: true },
    { icon: GraduationCap, number: "04", title: t(translations.services.trainingTitle, lang), description: t(translations.services.trainingDesc, lang) },
    { icon: Package, number: "05", title: t(translations.services.rentingTitle, lang), description: t(translations.services.rentingDesc, lang) },
  ];
          ...
          {services.map((service) => (
            <StaggerItem key={service.number}>
              ...
              >
                ...
                <h3 className="text-base font-semibold text-[#0A1628] mb-3">{service.title}</h3>
                <p className="text-sm leading-relaxed text-[#0A1628]/50">{service.description}</p>
              </div>
            </StaggerItem>
          ))}
        </StaggerChildren>
