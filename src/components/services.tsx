...
export function Services() {
  ...
  return (
    <section id="services" className="bg-[#080E1A] py-24 px-6 lg:py-32">
            ...
            <StaggerItem key={service.number}>
              <div
                className={`group h-full rounded-xl border p-8 transition-all duration-200 ${
                  service.featured
                    ? "border-[rgba(201,162,39,0.3)] bg-[#111C2E]"
                    : "border-[rgba(201,162,39,0.08)] bg-[#0D1525] hover:border-[rgba(201,162,39,0.2)] hover:bg-[#111C2E]"
                }`}
              >
